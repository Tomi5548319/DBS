...
"<button onclick=\"changeURL('v4/patches/');\">/v4/patches/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/players/14944/game_exp/');\">/v4/players/14944/game_exp/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/players/14944/game_objectives/');\">/v4/players/14944/game_objectives/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/players/14944/abilities/');\">/v4/players/14944/abilities/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/matches/21421/top_purchases/');\">/v4/matches/21421/top_purchases/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/abilities/5004/usage/');\">/v4/abilities/5004/usage/</button></form><br><br>" \
"<button onclick=\"changeURL('v4/statistics/tower_kills/');\">/v4/statistics/tower_kills/</button></form><br><br>"
...
@app.route('/v4/players/<string:player_id>/abilities/', methods=['GET'])
def v4_abilities(player_id):
    kurzor = connect_to_database()
...
def v4_matches_topPurchases(match_id):
    kurzor = connect_to_database()
...
@app.route('/v4/abilities/<string:ability_id>/usage/', methods=['GET'])
def v4_abilities_usage(ability_id):
    kurzor = connect_to_database()
